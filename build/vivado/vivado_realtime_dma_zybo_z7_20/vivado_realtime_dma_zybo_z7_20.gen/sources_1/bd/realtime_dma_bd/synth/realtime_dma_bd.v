...
//Command     : generate_target realtime_dma_bd.bd
//Design      : realtime_dma_bd
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "realtime_dma_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=realtime_dma_bd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "realtime_dma_bd.hwdef" *) 
module realtime_dma_bd
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  realtime_dma_bd_axi_dma0_0 axi_dma0
  ...
  realtime_dma_bd_axi_dma1_0 axi_dma1
       (.axi_resetn(rst_ps7_100m_peripheral_aresetn),
        .m_axi_mm2s_aclk(ps7_0_FCLK_CLK0),
  ...
  realtime_dma_bd_axi_smc_ctrl_0 axi_smc_ctrl
  ...
  realtime_dma_bd_axi_smc_mem_0 axi_smc_mem
  ...
  realtime_dma_bd_rst_ps7_100m_0 rst_ps7_100m
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  realtime_dma_bd_subband_realtime_0_0 subband_realtime_0
