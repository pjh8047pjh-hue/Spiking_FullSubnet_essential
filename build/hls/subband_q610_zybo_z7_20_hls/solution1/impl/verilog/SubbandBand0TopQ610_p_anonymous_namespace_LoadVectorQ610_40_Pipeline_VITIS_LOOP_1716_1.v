...
module SubbandBand0TopQ610_p_anonymous_namespace_LoadVectorQ610_40_Pipeline_VITIS_LOOP_1716_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [5:0] index_12_reg_125;
reg   [5:0] index_12_reg_125_pp0_iter1_reg;
reg   [15:0] weights_addr_read_reg_134;
wire   [31:0] zext_ln1718_fu_109_p1;
reg   [5:0] index_fu_46;
wire   [5:0] add_ln1716_fu_92_p2;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_index_12;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln1716_fu_86_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln1716_fu_86_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_index_12 = 6'd0;
    end else begin
...
assign add_ln1716_fu_92_p2 = (ap_sig_allocacmp_index_12 + 6'd1);
...
assign icmp_ln1716_fu_86_p2 = ((ap_sig_allocacmp_index_12 == 6'd40) ? 1'b1 : 1'b0);
...
assign proj_bias_local_address0 = zext_ln1718_fu_109_p1;

assign proj_bias_local_d0 = weights_addr_read_reg_134;

assign zext_ln1718_fu_109_p1 = index_12_reg_125_pp0_iter1_reg;

endmodule //SubbandBand0TopQ610_p_anonymous_namespace_LoadVectorQ610_40_Pipeline_VITIS_LOOP_1716_1
