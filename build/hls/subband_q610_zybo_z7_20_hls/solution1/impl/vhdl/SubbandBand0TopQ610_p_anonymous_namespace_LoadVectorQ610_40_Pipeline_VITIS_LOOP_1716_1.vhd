...
entity SubbandBand0TopQ610_p_anonymous_namespace_LoadVectorQ610_40_Pipeline_VITIS_LOOP_1716_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of SubbandBand0TopQ610_p_anonymous_namespace_LoadVectorQ610_40_Pipeline_VITIS_LOOP_1716_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1716_fu_86_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal index_12_reg_125 : STD_LOGIC_VECTOR (5 downto 0);
    signal index_12_reg_125_pp0_iter1_reg : STD_LOGIC_VECTOR (5 downto 0);
    signal weights_addr_read_reg_134 : STD_LOGIC_VECTOR (15 downto 0);
    signal zext_ln1718_fu_109_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal index_fu_46 : STD_LOGIC_VECTOR (5 downto 0) := "000000";
    signal add_ln1716_fu_92_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_index_12 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln1716_fu_86_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    index_fu_46 <= add_ln1716_fu_92_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    index_fu_46 <= ap_const_lv6_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                index_12_reg_125 <= ap_sig_allocacmp_index_12;
                index_12_reg_125_pp0_iter1_reg <= index_12_reg_125;
                weights_addr_read_reg_134 <= m_axi_weights_RDATA;
            end if;
        end if;
    end process;
    ...
    add_ln1716_fu_92_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_index_12) + unsigned(ap_const_lv6_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln1716_fu_86_p2)
    begin
        if (((icmp_ln1716_fu_86_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_index_12_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, index_fu_46, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_index_12 <= ap_const_lv6_0;
        else 
            ap_sig_allocacmp_index_12 <= index_fu_46;
        end if; 
    end process;

    icmp_ln1716_fu_86_p2 <= "1" when (ap_sig_allocacmp_index_12 = ap_const_lv6_28) else "0";
    ...
    proj_bias_local_address0 <= zext_ln1718_fu_109_p1(6 - 1 downto 0);

    proj_bias_local_ce0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
    ...
    proj_bias_local_d0 <= weights_addr_read_reg_134;

    proj_bias_local_we0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            proj_bias_local_we0 <= ap_const_logic_1;
        else 
    ...
    zext_ln1718_fu_109_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(index_12_reg_125_pp0_iter1_reg),32));
end behav;
