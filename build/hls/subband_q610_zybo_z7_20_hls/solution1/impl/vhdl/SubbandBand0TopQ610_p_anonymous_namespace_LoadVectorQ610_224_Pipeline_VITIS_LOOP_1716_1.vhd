...
entity SubbandBand0TopQ610_p_anonymous_namespace_LoadVectorQ610_224_Pipeline_VITIS_LOOP_1716_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of SubbandBand0TopQ610_p_anonymous_namespace_LoadVectorQ610_224_Pipeline_VITIS_LOOP_1716_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1716_fu_109_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal trunc_ln1716_fu_121_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln1716_reg_167 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln1716_reg_167_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal lshr_ln_reg_171 : STD_LOGIC_VECTOR (6 downto 0);
    signal lshr_ln_reg_171_pp0_iter1_reg : STD_LOGIC_VECTOR (6 downto 0);
    signal weights_addr_read_reg_176 : STD_LOGIC_VECTOR (15 downto 0);
    signal zext_ln1718_fu_146_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal index_fu_56 : STD_LOGIC_VECTOR (7 downto 0) := "00000000";
    signal add_ln1716_fu_115_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_index_13 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln1716_fu_109_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                lshr_ln_reg_171 <= ap_sig_allocacmp_index_13(7 downto 1);
    ...
    add_ln1716_fu_115_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_index_13) + unsigned(ap_const_lv8_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln1716_fu_109_p2)
    begin
        if (((icmp_ln1716_fu_109_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_index_13_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, index_fu_56, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_index_13 <= ap_const_lv8_0;
        else 
            ap_sig_allocacmp_index_13 <= index_fu_56;
        end if; 
    end process;

    icmp_ln1716_fu_109_p2 <= "1" when (ap_sig_allocacmp_index_13 = ap_const_lv8_E0) else "0";
    ...
    output_0_address0 <= zext_ln1718_fu_146_p1(7 - 1 downto 0);
    ...
    output_0_d0 <= weights_addr_read_reg_176;

    output_0_we0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, trunc_ln1716_reg_167_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (trunc_ln1716_reg_167_pp0_iter1_reg = ap_const_lv1_0))) then 
    ...
    output_1_address0 <= zext_ln1718_fu_146_p1(7 - 1 downto 0);
    ...
    output_1_d0 <= weights_addr_read_reg_176;

    output_1_we0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, trunc_ln1716_reg_167_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (trunc_ln1716_reg_167_pp0_iter1_reg = ap_const_lv1_1))) then 
    ...
    trunc_ln1716_fu_121_p1 <= ap_sig_allocacmp_index_13(1 - 1 downto 0);
    ...
    zext_ln1718_fu_146_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln_reg_171_pp0_iter1_reg),32));
end behav;
