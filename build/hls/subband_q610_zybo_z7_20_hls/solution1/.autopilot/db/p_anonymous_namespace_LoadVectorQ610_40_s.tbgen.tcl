set moduleName p_anonymous_namespace_LoadVectorQ610_40_s
set isTopModule 0
...
set C_modelName {(anonymous namespace)LoadVectorQ610<40>}
...
set portList { 
	...
	{ proj_bias_local_address0 sc_out sc_lv 6 signal 2 } 
	{ proj_bias_local_ce0 sc_out sc_logic 1 signal 2 } 
	{ proj_bias_local_we0 sc_out sc_logic 1 signal 2 } 
	{ proj_bias_local_d0 sc_out sc_lv 16 signal 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "weights", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_anonymous_namespace_LoadVectorQ610_40_Pipeline_VITIS_LOOP_1716_1_fu_51", "Port" : "weights", "Inst_start_state" : "9", "Inst_end_state" : "10"}]},
			{"Name" : "input_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "proj_bias_local", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_anonymous_namespace_LoadVectorQ610_40_Pipeline_VITIS_LOOP_1716_1_fu_51", "Port" : "proj_bias_local", "Inst_start_state" : "9", "Inst_end_state" : "10"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_anonymous_namespace_LoadVectorQ610_40_Pipeline_VITIS_LOOP_1716_1_fu_51", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_p_anonymous_namespace_LoadVectorQ610_40_Pipeline_VITIS_LOOP_1716_1_fu_51.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
