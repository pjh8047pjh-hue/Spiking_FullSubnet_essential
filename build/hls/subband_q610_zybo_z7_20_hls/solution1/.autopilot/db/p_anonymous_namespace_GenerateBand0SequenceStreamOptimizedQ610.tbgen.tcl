set moduleName p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610
set isTopModule 0
...
set C_modelName {(anonymous namespace)GenerateBand0SequenceStreamOptimizedQ610}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem_in int 16 regular {axi_master 0}  }
	{ noisy_input_q610 int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "noisy_input_q610","offset": { "type": "dynamic","port_name": "noisy_input_q610","bundle": "control"},"direction": "READONLY"},{"cName": "fb_output_q610","offset": { "type": "dynamic","port_name": "fb_output_q610","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "noisy_input_q610", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_gmem_in_RFIFONUM sc_in sc_lv 6 signal 0 } 
	...
	{ noisy_input_q610 sc_in sc_lv 32 signal 1 } 
	{ fb_output_q610 sc_in sc_lv 32 signal 2 } 
	{ sequence_stream_din sc_out sc_lv 16 signal 3 } 
	{ sequence_stream_num_data_valid sc_in sc_lv 8 signal 3 } 
	{ sequence_stream_fifo_cap sc_in sc_lv 8 signal 3 } 
	{ sequence_stream_full_n sc_in sc_logic 1 signal 3 } 
	{ sequence_stream_write sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "noisy_input_q610", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "noisy_input_q610", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "4"],
		"CDFG" : "p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1391041", "EstimateLatencyMax" : "1391041",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "gmem_in", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610_Pipeline_VITIS_LOO_fu_101", "Port" : "gmem_in", "Inst_start_state" : "6", "Inst_end_state" : "7"},
					{"ID" : "1", "SubInstance" : "grp_p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610_Pipeline_VITIS_LOO_1_fu_90", "Port" : "gmem_in", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "noisy_input_q610", "Type" : "None", "Direction" : "I"},
			{"Name" : "fb_output_q610", "Type" : "None", "Direction" : "I"},
			{"Name" : "sequence_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "128", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610_Pipeline_VITIS_LOO_fu_101", "Port" : "sequence_stream", "Inst_start_state" : "6", "Inst_end_state" : "7"},
					{"ID" : "1", "SubInstance" : "grp_p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610_Pipeline_VITIS_LOO_1_fu_90", "Port" : "sequence_stream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_1798_1_VITIS_LOOP_1800_2", "PipelineType" : "no",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610_Pipeline_VITIS_LOO_1_fu_90", "Parent" : "0", "Child" : ["2", "3"],
		"CDFG" : "p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610_Pipeline_VITIS_LOO_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "zext_ln1802", "Type" : "None", "Direction" : "I"},
			{"Name" : "zext_ln1798_1", "Type" : "None", "Direction" : "I"},
			{"Name" : "noisy_input_q610", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem_in", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_1802_3", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter13", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter13", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610_Pipeline_VITIS_LOO_1_fu_90.mac_muladd_7s_12ns_12ns_18_4_1_U82", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610_Pipeline_VITIS_LOO_1_fu_90.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610_Pipeline_VITIS_LOO_fu_101", "Parent" : "0", "Child" : ["5", "6"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_1810_4", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter13", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter13", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610_Pipeline_VITIS_LOO_fu_101.ama_addmuladd_5ns_3ns_12ns_12ns_17_4_1_U89", "Parent" : "4"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610_Pipeline_VITIS_LOO_fu_101.flow_control_loop_pipe_sequential_init_U", "Parent" : "4"}]}


set ArgLastReadFirstWriteLatency {
	p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610 {
		gmem_in {Type I LastRead 12 FirstWrite -1}
		noisy_input_q610 {Type I LastRead 0 FirstWrite -1}
		fb_output_q610 {Type I LastRead 0 FirstWrite -1}
		sequence_stream {Type O LastRead -1 FirstWrite 13}}
	p_anonymous_namespace_GenerateBand0SequenceStreamOptimizedQ610_Pipeline_VITIS_LOO_1 {
		zext_ln1802 {Type I LastRead 0 FirstWrite -1}
		zext_ln1798_1 {Type I LastRead 0 FirstWrite -1}
		noisy_input_q610 {Type I LastRead 0 FirstWrite -1}
		gmem_in {Type I LastRead 12 FirstWrite -1}
		sequence_stream {Type O LastRead -1 FirstWrite 13}}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1391041", "Max" : "1391041"}
	, {"Name" : "Interval", "Min" : "1391041", "Max" : "1391041"}
]}
...
set Spec2ImplPortList { 
	...
	noisy_input_q610 { ap_none {  { noisy_input_q610 in_data 0 32 } } }
