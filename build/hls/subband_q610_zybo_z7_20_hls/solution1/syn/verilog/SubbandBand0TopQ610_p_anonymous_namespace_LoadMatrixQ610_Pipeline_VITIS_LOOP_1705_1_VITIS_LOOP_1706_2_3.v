...
module SubbandBand0TopQ610_p_anonymous_namespace_LoadMatrixQ610_Pipeline_VITIS_LOOP_1705_1_VITIS_LOOP_1706_2_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln1705_fu_139_p2;
...
wire   [0:0] trunc_ln1706_fu_208_p1;
reg   [0:0] trunc_ln1706_reg_283;
wire   [7:0] add_ln1708_fu_226_p2;
reg   [7:0] add_ln1708_reg_287;
reg   [15:0] weights_addr_read_reg_292;
wire   [31:0] zext_ln1708_1_fu_248_p1;
reg   [7:0] col_fu_68;
wire   [7:0] add_ln1706_fu_232_p2;
wire    ap_loop_init;
reg   [1:0] row_fu_72;
wire   [1:0] select_ln1705_1_fu_188_p3;
reg   [8:0] indvar_flatten_fu_76;
wire   [8:0] add_ln1705_1_fu_145_p2;
reg   [8:0] ap_sig_allocacmp_indvar_flatten_load;
wire   [0:0] icmp_ln1706_fu_174_p2;
wire   [1:0] add_ln1705_fu_168_p2;
wire   [0:0] trunc_ln1708_fu_196_p1;
wire   [7:0] select_ln1705_fu_180_p3;
wire   [6:0] lshr_ln_fu_212_p4;
wire   [7:0] select_ln1706_fu_200_p3;
wire   [7:0] zext_ln1708_fu_222_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln1705_fu_139_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln1705_fu_139_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln1706_reg_283 == 1'd0))) begin
        output_0_we0 = 1'b1;
    end else begin
        output_0_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln1706_reg_283 == 1'd1))) begin
        output_1_we0 = 1'b1;
    end else begin
        output_1_we0 = 1'b0;
    end
...
assign add_ln1705_1_fu_145_p2 = (ap_sig_allocacmp_indvar_flatten_load + 9'd1);

assign add_ln1705_fu_168_p2 = (row_fu_72 + 2'd1);

assign add_ln1706_fu_232_p2 = (select_ln1705_fu_180_p3 + 8'd1);

assign add_ln1708_fu_226_p2 = (select_ln1706_fu_200_p3 + zext_ln1708_fu_222_p1);
...
assign icmp_ln1705_fu_139_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 9'd448) ? 1'b1 : 1'b0);

assign icmp_ln1706_fu_174_p2 = ((col_fu_68 == 8'd224) ? 1'b1 : 1'b0);

assign lshr_ln_fu_212_p4 = {{select_ln1705_fu_180_p3[7:1]}};
...
assign output_0_address0 = zext_ln1708_1_fu_248_p1;

assign output_0_d0 = weights_addr_read_reg_292;

assign output_1_address0 = zext_ln1708_1_fu_248_p1;

assign output_1_d0 = weights_addr_read_reg_292;

assign select_ln1705_1_fu_188_p3 = ((icmp_ln1706_fu_174_p2[0:0] == 1'b1) ? add_ln1705_fu_168_p2 : row_fu_72);

assign select_ln1705_fu_180_p3 = ((icmp_ln1706_fu_174_p2[0:0] == 1'b1) ? 8'd0 : col_fu_68);

assign select_ln1706_fu_200_p3 = ((trunc_ln1708_fu_196_p1[0:0] == 1'b1) ? 8'd112 : 8'd0);

assign trunc_ln1706_fu_208_p1 = select_ln1705_fu_180_p3[0:0];

assign trunc_ln1708_fu_196_p1 = select_ln1705_1_fu_188_p3[0:0];

assign zext_ln1708_1_fu_248_p1 = add_ln1708_reg_287;

assign zext_ln1708_fu_222_p1 = lshr_ln_fu_212_p4;

endmodule //SubbandBand0TopQ610_p_anonymous_namespace_LoadMatrixQ610_Pipeline_VITIS_LOOP_1705_1_VITIS_LOOP_1706_2_3
