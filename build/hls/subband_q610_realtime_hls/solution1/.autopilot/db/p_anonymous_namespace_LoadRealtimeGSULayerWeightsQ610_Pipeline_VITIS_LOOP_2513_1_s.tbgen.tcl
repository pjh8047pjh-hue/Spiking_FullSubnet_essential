set moduleName p_anonymous_namespace_LoadRealtimeGSULayerWeightsQ610_Pipeline_VITIS_LOOP_2513_1_s
set isTopModule 0
...
set C_modelName {(anonymous namespace)LoadRealtimeGSULayerWeightsQ610_Pipeline_VITIS_LOOP_2513_1_}
