...
entity SubbandRealtimeTopQ610Ip_fifo_w96_d2_S is 
    generic (
...
architecture rtl of SubbandRealtimeTopQ610Ip_fifo_w96_d2_S is

    component SubbandRealtimeTopQ610Ip_fifo_w96_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 96;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_SubbandRealtimeTopQ610Ip_fifo_w96_d2_S_ShiftReg : SubbandRealtimeTopQ610Ip_fifo_w96_d2_S_ShiftReg
    generic map (
...
entity SubbandRealtimeTopQ610Ip_fifo_w96_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 96;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end SubbandRealtimeTopQ610Ip_fifo_w96_d2_S_ShiftReg;

architecture rtl of SubbandRealtimeTopQ610Ip_fifo_w96_d2_S_ShiftReg is
