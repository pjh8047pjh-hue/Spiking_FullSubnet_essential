...
# C단계: USE_SV_GSU_LAYER + USE_PROJECTION_EXTERNAL csim
# projection dot product를 외부 stream으로 위임. testbench가 std::thread로 외부 IP 모사.
set ::env(HLS_EXTRA_CFLAGS) "-DUSE_SV_GSU_LAYER -DUSE_PROJECTION_EXTERNAL"

open_project -reset [hls_prepare_project subband_q610_realtime_sv_gsu_blackbox_proj_ext_csim_hls subband_realtime_hls_tb.cpp]
